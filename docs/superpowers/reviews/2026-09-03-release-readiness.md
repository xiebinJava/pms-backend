...
| 跨仓库集成 CI `33703454221` | 通过：OceanBase、V1–V12 幂等、API 冒烟、登录代理、桌面/移动端 Playwright |
| 前端独立 CI `33703279912` | 通过：隐私扫描、121 项测试、类型检查、构建、镜像高危扫描、SPDX SBOM |
...
已确认跨仓库只读凭据配置有效；最终远程集成运行 `33703454221` 使用后端 `6ac7fa5` 与前端
