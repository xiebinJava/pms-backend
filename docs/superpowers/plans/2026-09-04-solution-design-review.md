...
**Spec:** `../pms-front/public/solution-design-review-demo-v2.html`（已验收的 V2 交互原型）及其对应的本轮用户确认方案。
...
- Create: `../pms-front/src/api/node-solution-design.ts`
- Create: `../pms-front/src/views/project/detail/solution-design.ts`
- Test: `../pms-front/src/views/project/detail/solution-design.test.mjs`
...
- [ ] **Step 2: Run the frontend tests to verify they fail**
  ...
  Run `cd ../pms-front && pnpm test -- src/views/project/detail/solution-design.test.mjs`.
...
**Files:**
- Create: `../pms-front/src/views/project/detail/components/SolutionDesignWorkbench.vue`
...
- [ ] **Step 4: Run frontend unit/type/build checks**
  ...
  Run `cd ../pms-front && pnpm test`, `pnpm typecheck`, and `pnpm build`.
...
- Modify: `../pms-front/src/views/project/detail/solution-design.test.mjs`
...
- [ ] **Step 3: Run backend and frontend regression suites**
  ...
  Run `mvn -q test`, `cd ../pms-front && pnpm test && pnpm typecheck && pnpm build`.
  Expected: PASS.
