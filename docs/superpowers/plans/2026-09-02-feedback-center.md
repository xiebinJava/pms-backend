...
**Files:**
- Create: `../pms-front/src/api/feedback.ts`
- Create: `../pms-front/src/views/feedback/index.vue`
- Create: `../pms-front/src/views/feedback/feedback.test.mjs`
...
- Modify: `../pms-front/docs/user-manual.md` if present, otherwise add the feedback-center usage section to the existing frontend docs location.
