...
- Modify: `../pms-front/src/api/node-plan-resource-risk.ts`
- Modify: `../pms-front/src/views/project/detail/plan-resource-risk.ts`
- Modify: `../pms-front/src/views/project/detail/components/PlanResourceRiskWorkbench.vue`
- Modify: `../pms-front/src/views/project/detail/plan-resource-risk.test.mjs`
...
**Files:**
- Modify: `../pms-front/src/types/domain.ts`
- Create or modify: `../pms-front/src/api/iteration-plan.ts`
...
**Files:**
- Modify: `../pms-front/src/views/project/detail/index.vue`
- Modify: `../pms-front/src/views/project/detail/components/Milestones.vue` (remove mount/use or leave unreachable if routing compatibility requires it)
- Modify: `../pms-front/src/views/project/detail/workflow.ts`
- Modify: `../pms-front/src/views/project/detail/workflow.test.mjs`
- Modify: `../pms-front/src/api/milestone.ts` only if no active page imports it
...
1. Run `mvn -q test` and `mvn -q -DskipTests package` in `.`.
2. Run `pnpm test`, `pnpm typecheck`, and `pnpm build` in `../pms-front`.
