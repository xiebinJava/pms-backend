...
- Modify: `../pms-front/src/api/admin-audit.ts`
...
- Create: `../pms-front/src/views/admin/audit/audit.test.mjs`
...
- Create: `scripts/audit-acceptance.sh`
- Test: `src/test/java/com/brad/pms/controller/AdminAuditPermissionAnnotationTest.java`
