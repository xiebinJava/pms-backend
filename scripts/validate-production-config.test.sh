...
base_env=(
  ...
  "OCEANBASE_HOST=db.internal.example"
  "OCEANBASE_PORT=2881"
  "OCEANBASE_DATABASE=brad_pms"
  "OCEANBASE_USER=pms_app@test"
  "OCEANBASE_PASSWORD=synthetic-only-password"
...
expect_status 2 "invalid OceanBase port is rejected" env "${base_env[@]}" OCEANBASE_PORT=not-a-port bash "$VALIDATOR"
